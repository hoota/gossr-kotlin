...
fun GetRoute.buildUri(): String = RoutesHelper.getRouteUrl(this)
fun Route.buildUriPath(): String = RoutesHelper.getRouteUrlPath(this)
fun Route.getEndpointMethodAnnotations(): Array<Annotation>? = RoutesHelper.getAnnotations(this)